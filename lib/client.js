window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		async function importCodexWorkspace(cwd, onProgress, fetchImpl = fetch) {
		...
		function workspaceImportUiPolicy(phase, ready = 0, failed = 0) {
		...
		function WorkspaceImportAction({ wide, useWorkspaceImportWorkspaces, useWorkspaceImportSessions, scanWorkspace, importWorkspace, refreshWorkspaceState, t }) {
			const availableTarget = resolveImportWorkspace(useWorkspaceImportWorkspaces((value) => value), useWorkspaceImportSessions((value) => value));
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						phase === "summary" && summary !== null && (summary.found === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: WorkspaceImportAction_module_css_default.message,
		...
		function modalFooter({ phase, summary, result, close, retry, importAll, t }) {
